...
public class PreRollActivity extends BaseActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		if(savedInstanceState != null)
		{
			...
			this.xmlDocumentURLString=getIntent().getExtras().getString(PREROLLACTIVITY_XMLDOCUMENTURL_KEY);
		}
	...
	protected void onSaveInstanceState(Bundle outState) {
		...
		outState.putString(PREROLLACTIVITY_XMLDOCUMENTURL_KEY, xmlDocumentURLString);
