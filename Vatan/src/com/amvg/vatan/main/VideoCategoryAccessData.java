...
public class VideoCategoryAccessData extends AsyncTask<String, String, String>{
	...
	public VideoCategoryAccessData(Context context, ListView lv, Context contextDialog, String categoryName, String categoryID, String isVideo){
		this.global=new Global();
		this.context=context;
		this.listview=lv;
		this.dirName="/sdcard/Vatan/videocategory";
		this.pathName="http://mw.milliyet.com.tr/ashx/Milliyet.ashx?aType=MobileAPI_VatanTVVideoClips&CategoryID="+categoryID+"&PageIndex=0&PageSize=25";
