...
public final class VatanTvFragment extends Fragment {
    ...
    private View view;
    private int index=0;
    private static String DirName="/sdcard/Vatan/vatantv/";
    ...
    public static VatanTvFragment newInstance(ArrayList<DataModelVideoHeadlines> results, int position, Context context, Context contextDialog, String controller) 
    {
    	appMap=new AppMap(context,contextDialog);
    	results_array=results;
        VatanTvFragment fragment = new VatanTvFragment();
        fragment.index=position;
        if (controller.toLowerCase().equals("milliyettv") || controller.toLowerCase().equals("dummymilliyettv"))
		{
			DirName="/sdcard/Vatan/vatantv/";
			TvName="MilliyetTV";
		}
        else
        {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) 
    {
        ...
        view = LayoutInflater.from(getActivity()).inflate(R.layout.vatantv_headlines,null);
