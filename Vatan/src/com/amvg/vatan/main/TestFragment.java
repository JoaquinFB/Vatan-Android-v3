...
public final class TestFragment extends Fragment 
{
    ...
    private View view;
    private int index=0;
    private static String DirName="/sdcard/Vatan/home/";
    private static AppMap appMap;

    public static TestFragment newInstance(ArrayList<DataModelHomeHeadlines> results, int position, Context context, Context contextDialog, String pathName) 
    {
    	DirName="/sdcard/Vatan/"+pathName+"/";
